...
- `ALGORAND_SENDER_WALLET_ID` = a Dfns [wallet](https://docs.dfns.co/api-reference/wallets) ID
- `ALGORAND_RECEIVER_WALLET_ID` = a Dfns [wallet](https://docs.dfns.co/api-reference/wallets) ID

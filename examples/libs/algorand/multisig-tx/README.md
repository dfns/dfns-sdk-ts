...
- `ALGORAND_WALLET_ID_1` = a Dfns [wallet](https://docs.dfns.co/api-reference/wallets) ID
- `ALGORAND_WALLET_ID_2` = a Dfns [wallet](https://docs.dfns.co/api-reference/wallets) ID

...
Wallet import is an opt-in feature at Dfns. So first, you need to request to Dfns this feature. Then, the API User / Service Account that you'll use needs a couple permissions:
- `Signers:ListSigners`
- `Keys:Import`
- `Wallets:Create`

...
*/
class KeyExportContext {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(KeyExportContext.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_keyexportcontext_free(ptr);
    }
    /**
    ...
    */
    static new() {
        try {
            ...
            wasm.keyexportcontext_new(retptr);
            ...
            return KeyExportContext.__wrap(r0);
        } finally {
    ...
    * @returns {any}
    */
    buildKeyExportRequest() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.keyexportcontext_buildKeyExportRequest(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    * @returns {SecretKey}
    */
    recoverSecretKey(response) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.keyexportcontext_recoverSecretKey(retptr, this.__wbg_ptr, addHeapObject(response));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
module.exports.KeyExportContext = KeyExportContext;
/**
...
const path = require('path').join(__dirname, 'dfns_key_export_client_bg.wasm');

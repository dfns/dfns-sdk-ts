...
export class AuthClient {
  ...
  async updateServiceAccountToken(
  ...
  async archiveServiceAccountToken(
  ...
  async activateServiceAccountToken(
  ...
  async deactivateServiceAccountToken(
  ...
  async activateApplicationToken(
  ...
  async deactivateApplicationToken(

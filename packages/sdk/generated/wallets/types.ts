...
export type GetTransferResponse = {
    ...
    requestBody: {
        kind: "Native";
        to: string | string | string | string | string | string | string | string;
        amount: string;

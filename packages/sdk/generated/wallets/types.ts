...
export type AbortTransactionResponse = {
    ...
    requestBody: {
        kind: "Transaction";
        /** A JSON transaction object (recommended for EVM and other compatible networks) or an unsigned hex-encoded transaction. */
        transaction: string | {};
        ...
        kind: "SolanaCctpBurn";
        /** Source USDC SPL mint address. */
        usdcMint: string;
        /** USDC amount to burn (6 decimals). */
        amount: string;
        /** CCTP destination domain. */
        destinationDomain: number;
        /** Destination recipient as a bytes32 0x-hex value (EVM address left-padded). */
        mintRecipient: string;
        /** Max fee Circle may deduct from the burn. */
        maxFee: string;
        /** CCTP min finality threshold (1000 Fast, 2000 Standard). */
...
export type BulkCreateWalletsBody = {
    /** Network the wallets will be created on. */
    network: "Ethereum" | "EthereumSepolia" | "EthereumHolesky" | "EthereumHoodi" | "Bsc" | "BscTestnet" | "Base" | "BaseSepolia" | "ArbitrumOne" | "ArbitrumSepolia" | "Optimism" | "OptimismSepolia" | "Tron" | "TronNile" | "Solana" | "SolanaDevnet";
...
export type BulkCreateWalletsResponse = {
...
export type BulkCreateWalletsRequest = { body: BulkCreateWalletsBody }
...
export type CantonLedgerApiProxyBody = {
...
export type CantonLedgerApiProxyParams = {
    /** Wallet id. */
    walletId: string;
};

export type CantonLedgerApiProxyResponse = unknown;

export type CantonLedgerApiProxyRequest = CantonLedgerApiProxyParams & { body: CantonLedgerApiProxyBody }
...
export type GetBulkWalletJobParams = {
    /** The bulk wallet creation job to retrieve. */
    jobId: string;
};

export type GetBulkWalletJobResponse = {
    /** ID of the bulk wallet creation job. */
    id: string;
    ...
    reason?: string | undefined;
    /** [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date string when the job is next retried. */
    nextRetryDate?: string | undefined;
    /** Number of retry attempts made so far. */
    nextRetryAttempt?: number | undefined;
    /** [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date string when the job was created. */
    dateCreated: string;
    /** [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date string when the job was last updated. */
    dateUpdated: string;
    /** [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date string when the job finished. */
    dateCompleted?: string | undefined;
};

export type GetBulkWalletJobRequest = GetBulkWalletJobParams
...
export type GetWalletAssetsQuery = {
    /** Set to `true` to include the total fiat value (net worth) of all assets held in the wallet. */
...
export type GetWalletAssetsResponse = {
    ...
    assets: (({
        ...
        verified?: boolean | undefined;
        balance: string;
        /** Current market price of the asset, keyed by fiat currency (e.g. USD). Sourced from DFNS market data. */
        quotes?: {
            [x: string]: number;
        } | undefined;
    })[];
    /** Total fiat value (net worth) of all assets held in the wallet, keyed by currency (e.g. USD). Returned only when the request includes `netWorth=true`. */
    netWorth?: {
        [x: string]: number;
    } | undefined;
};
...
export type GetWalletHistoryResponse = {
    ...
    items: ({
        ...
        /** EVM keccak256 hash of the HIP-410 inner tx. Absent on legacy-migrated rows. */
...
export type ListBulkWalletJobsQuery = {
    /** Maximum number of items to return. */
    limit?: number | undefined;
    /** Opaque token used to retrieve the next page. Returned as `nextPageToken` from the previous request. */
    paginationToken?: string | undefined;
    /** Filter jobs by status. */
    status?: ("Pending" | "InProgress" | "Completed" | "PartiallyCompleted" | "Failed") | undefined;
};

export type ListBulkWalletJobsResponse = {
    /** Current page items. */
    items: {
        /** ID of the bulk wallet creation job. */
        id: string;
...
export type ListBulkWalletJobsRequest = { query?: ListBulkWalletJobsQuery }

export type ListBulkWalletJobWalletsParams = {
    /** The bulk wallet creation job whose wallets to list. */
    jobId: string;
};

export type ListBulkWalletJobWalletsQuery = {
    /** Maximum number of items to return. */
    limit?: number;
    /** Opaque token used to retrieve the next page. Returned as `nextPageToken` from the previous request. */
    paginationToken?: string | undefined;
...
export type ListBulkWalletJobWalletsResponse = {
    /** Current page items. */
    items: {
        /** ID of the wallet. */
        id: string;
...
export type ListBulkWalletJobWalletsRequest = ListBulkWalletJobWalletsParams & { query?: ListBulkWalletJobWalletsQuery }
...
export type SignAndBroadcastTransactionBody = {
    kind: "Transaction";
    /** A JSON transaction object (recommended for EVM and other compatible networks) or an unsigned hex-encoded transaction. */
    transaction: string | {};
    /** A unique ID from your system. It can be leveraged to be used as an idempotency key (read more [here](https://docs.dfns.co/api-reference/idempotency)). */
...
export type SignAndBroadcastTransactionParams = {
    /** Wallet id. */
    walletId: string;
};

export type SignAndBroadcastTransactionResponse = {
    /** Transaction id. */
    id: string;
    /** Wallet id. */
    walletId: string;
...
export type SignAndBroadcastTransactionRequest = SignAndBroadcastTransactionParams & { body: SignAndBroadcastTransactionBody }

export type BroadcastTransactionBody = SignAndBroadcastTransactionBody

export type BroadcastTransactionParams = SignAndBroadcastTransactionParams

export type BroadcastTransactionResponse = SignAndBroadcastTransactionResponse

export type BroadcastTransactionRequest = SignAndBroadcastTransactionRequest

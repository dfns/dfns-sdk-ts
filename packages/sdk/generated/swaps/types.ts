...
export type RequestSwapQuoteBody = {
    provider: "UniswapClassic";
    /** Id of the Dfns wallet spending the sourceAsset. */
    walletId: string;
    /** Id of the Dfns wallet receiving the target asset. Currently this value must be the same as the `walletId`. */
...
export type RequestSwapQuoteResponse = {
    /** ID of the Swap Quote. */
    id: string;
    /** Id of the Dfns wallet spending the sourceAsset. */
    walletId: string;
...
export type RequestSwapQuoteRequest = { body: RequestSwapQuoteBody }

export type CreateSwapQuoteBody = RequestSwapQuoteBody

export type CreateSwapQuoteResponse = RequestSwapQuoteResponse

export type CreateSwapQuoteRequest = RequestSwapQuoteRequest
